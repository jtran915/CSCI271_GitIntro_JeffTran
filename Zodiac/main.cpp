...
int main() {
    ...
    if ((month == 1 && day >= 20) || (month == 2 && day >= 18)) zodiac = "Aries";
    ...
    else if ((month == 11 && day >= 21) || (month == 12 && day <= 21)) zodiac = "Sagittarius";
    else if ((month == 12 && day >= 21) || (month == 1 && day <= 19)) zodiac = "Capricorn";
